...
export const SchoolClient = {
  getSchools: () => (!env.useMock ? MockSchoolClient.getSchools() : RealSchoolClient.getSchools()),
  getSchoolsByDistrict: districtId =>
    !env.useMock
      ? MockSchoolClient.getSchoolsByDistrict(districtId)
      : RealSchoolClient.getSchoolsByDistrict(districtId),
  createSchool: data =>
